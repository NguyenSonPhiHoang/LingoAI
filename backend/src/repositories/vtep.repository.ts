...
export class VtepRepository {
  ...
  static async listDocuments(): Promise<any[]> {
    ...
    const res = await pool.request().query(`
      SELECT Id as id, Title as title, Description as description, FileName as fileName, FilePath as filePath, PageCount as pageCount, TocJson as tocJson, CreatedByUserId as createdByUserId, CreatedAt as createdAt
