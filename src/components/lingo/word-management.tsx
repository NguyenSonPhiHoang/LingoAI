...
import { Loader2, Search, Pencil, Volume2, Wand2 } from "lucide-react";
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <FormItem>
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <Button
                      ...
                      onClick={async () => {
                        ...
                        try {
                          const details = await generateWordDetails({
                            term: form.getValues("term") || word.term,
                          });
                          const ipa = (details.pronunciation || "").trim();
                          if (ipa) {
                            form.setValue("pronunciation", ipa, {
                              shouldDirty: true,
                            });
                            toast({
                              title: "AI generated",
                            ...
                            toast({
                              ...
                              title: "Error",
                              description:
                                "AI did not return an IPA pronunciation.",
                            });
                          }
                        } catch (error) {
                          console.error(
                      ...
                      disabled={isGeneratingAi || form.formState.isSubmitting}
                    >
                      {isGeneratingAi ? (
            ...
            <DialogFooter>
              ...
              <Button
                type="submit"
                disabled={form.formState.isSubmitting || isGeneratingAi}
              >
...
const WordManagement: FC = () => {
  ...
  const { audioRef, isLoadingAudio, playGlobalWordAudio } = useAudioPlayback({
    setWords: () => {},
    speechRate,
  });
  ...
  return (
    <Card>
      ...
      <CardHeader>
        ...
        <CardDescription>
          View and edit the global vocabulary list. There are currently{" "}
          {words.length} words in the database. Changes made here will affect
          all users.
        </CardDescription>
              ...
              <TableRow key={word.id}>
                ...
                <TableCell>
                  <Button
                    ...
                    className={
                      word.audioUrl ? "text-primary" : "text-muted-foreground"
                    }
                  >
                    {isLoadingAudio[word.id] ? (
